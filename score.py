...
# Delete tie bars and stress marks
#    - U+035C combining double breve below (tie-bar below)
#    - U+0361 combining double inverted breve (tie-bar above)
#    - U+02C8 primary stress (ˈ), U+02CC secondary stress (ˌ)
#    - U+0303 combining tilde (used for nasalization, but we don't include)
_DELETE_TIE_AND_STRESS = {
    ord("\u035c"): None,
    ord("\u0361"): None,
    ord("\u02c8"): None,
    ord("\u02cc"): None,
    ord("\u0303"): None,  # remove combining tildes if they exist independently
}

# Normalize rhotics to a single form (ɚ)
_RHOTIC_TO_SCHWA_RHOTIC = {
    ord("ɝ"): "ɚ",
}

# Remove ASCII punctuation
_PUNCT_DELETE = {c: None for c in string.punctuation}

# Compose translation in a single table for speed
...
__all__ = ["english_spelling_normalizer", "VALID_IPA_CHARS", "_TRANSLATION",]
